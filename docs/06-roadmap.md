...
| **Риски** | **Q-1/Q-2** (рантайм и железо) нужны здесь; слабая модель → заложить fallback JSON-режим уже сейчас |
| **Объём** | ⏱ 5–7 |
...
- [ ] Получены ответы на Q-1, Q-2 (рантайм, железо) — [01-requirements.md §4](01-requirements.md)
